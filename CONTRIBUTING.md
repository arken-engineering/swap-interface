...
You can start by reading our [Contribution guidelines](https://docs.arcane.finance/code/contributing) first.
...
Translation in crowdin: `%asset% Earned` [link](https://crowdin.com/translate/arcanefinance/8/en-de#330)
